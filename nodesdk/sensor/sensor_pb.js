 ...
 * @return {!proto.sensorService.DataObs} returns this
 */
...
proto.sensorService.DataAgv.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    dataList: (f = jspb.Message.getRepeatedBooleanField(msg, 2)) == null ? undefined : f
  };
...
/**
 * @param {string} value
 * @return {!proto.sensorService.DataAgv} returns this
 */
...
/**
 * Clears values from the map. The map will be non-null.
 * @return {!proto.sensorService.DataTouch} returns this
 */
 ...
 * @return {!proto.sensorService.UpdateReq} returns this
 */
...
/**
 * @param {!proto.sensorService.DataType} value
 * @return {!proto.sensorService.RawResponse} returns this
 */
