...
GetScanDataRequest = _reflection.GeneratedProtocolMessageType('GetScanDataRequest', (_message.Message,), dict(
...
GetScanDataResponse = _reflection.GeneratedProtocolMessageType('GetScanDataResponse', (_message.Message,), dict(
