...
/*
Package messagingService is a reverse proxy.
...
func request_MessagingService_Messaging_0(ctx context.Context, marshaler runtime.Marshaler, client MessagingServiceClient, req *http.Request, pathParams map[string]string) (MessagingService_MessagingClient, runtime.ServerMetadata, error) {
...
func RegisterMessagingServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client MessagingServiceClient) error {
	...
	mux.Handle("GET", pattern_MessagingService_Messaging_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_MessagingService_Messaging_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_MessagingService_Messaging_0(ctx, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
...
var (
	pattern_MessagingService_Messaging_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 2}, []string{"api", "v2", "messaging"}, "", runtime.AssumeColonVerbOpt(true)))
)

var (
	forward_MessagingService_Messaging_0 = runtime.ForwardResponseStream
)
