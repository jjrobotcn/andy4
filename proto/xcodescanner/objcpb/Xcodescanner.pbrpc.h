...
@protocol XCodeScannerService2 <NSObject>
 ...
 */
@protocol XCodeScannerService <NSObject>
 ...
 */
@interface XCodeScannerService : GRPCProtoService<XCodeScannerService, XCodeScannerService2>
