...
/*
Package powerService is a reverse proxy.
...
var (
	filter_PowerService_Switch_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
func request_PowerService_Switch_0(ctx context.Context, marshaler runtime.Marshaler, client PowerServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_PowerService_Switch_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func RegisterPowerServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client PowerServiceClient) error {
	...
	mux.Handle("GET", pattern_PowerService_Switch_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req)
