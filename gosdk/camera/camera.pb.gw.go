...
func local_request_CameraService_LatestImage_0(ctx context.Context, marshaler runtime.Marshaler, server CameraServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq LatestImageRequest
	var metadata runtime.ServerMetadata

	msg, err := server.LatestImage(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterCameraServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server CameraServiceServer) error {
	...
	mux.Handle("GET", pattern_CameraService_LatestImage_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_CameraService_LatestImage_0(rctx, inboundMarshaler, server, req, pathParams)
