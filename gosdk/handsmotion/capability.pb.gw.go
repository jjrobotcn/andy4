...
func request_Capability_SetJointOriginPos_0(ctx context.Context, marshaler runtime.Marshaler, client CapabilityClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq SetJointOriginPosRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.SetJointOriginPos(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_Capability_SetJointOriginPos_0(ctx context.Context, marshaler runtime.Marshaler, server CapabilityServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq SetJointOriginPosRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.SetJointOriginPos(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterCapabilityHandlerServer(ctx context.Context, mux *runtime.ServeMux, server CapabilityServer) error {
	...
	mux.Handle("POST", pattern_Capability_SetJointOriginPos_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req)
		...
		resp, md, err := local_request_Capability_SetJointOriginPos_0(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_Capability_SetJointOriginPos_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("GET", pattern_Capability_GetAbsolutePosition_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req)
...
func RegisterCapabilityHandlerClient(ctx context.Context, mux *runtime.ServeMux, client CapabilityClient) error {
	...
	mux.Handle("POST", pattern_Capability_SetJointOriginPos_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Capability_SetJointOriginPos_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_Capability_SetJointOriginPos_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 2, 5}, []string{"api", "v2", "motion", "hands", "capability", "set_joint_origin_pos"}, "", runtime.AssumeColonVerbOpt(true)))
...
var (
	...
	forward_Capability_SetJointOriginPos_0 = runtime.ForwardResponseMessage
